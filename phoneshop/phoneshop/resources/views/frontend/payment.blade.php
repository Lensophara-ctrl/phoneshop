    ...
    <div class="bakong-card">
        ...
        <div class="qr-section">
            ...
            <div class="barcode-section">
                ...
                <div class="barcode-number">{{ $billNumber }}</div>
            </div>
        ...
        <div class="balance-section">
            ...
            <div class="balance-amount">${{ number_format($totalAmount, 2) }}</div>
        </div>
        ...
        <div id="invoiceSection" style="display: none;">
            ...
            <a href="{{ route('shop.success', $billNumber) }}" class="continue-btn">
    ...
    <div id="printableInvoice" style="display: none;">
        <div class="invoice-container">
            ...
            <div class="invoice-customer">
                <h4>Billed To:</h4>
                <p><strong>Customer:</strong> {{ auth()->user()->name ?? 'Guest' }}</p>
