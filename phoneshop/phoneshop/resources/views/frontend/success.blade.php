    ...
    <div class="col-md-8">
        <div class="text-center no-print mb-4">
            ...
            <div class="d-flex justify-content-center gap-3 mt-4 flex-wrap">
                ...
                <a href="{{ route('shop.home') }}" class="btn btn-outline-secondary rounded-pill px-4">
            ...
            <div class="card-body p-5">
                <div class="row mb-5">
                    ...
                    <div class="col-3 text-center">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data={{ urlencode($billNo) }}" 
                             alt="Bill QR" 
                    ...
                    <div class="col-3 text-end">
                        ...
                        <div class="text-muted small">Bill No: <strong>#{{ $billNo }}</strong></div>
                        <div class="text-muted small">Date: {{ date('M d, Y') }}</div>
                    </div>
                </div>
                ...
                <div class="row mb-5">
                    <div class="col-12">
                        ...
                        <div class="fw-bold h5 mb-1">{{ $customer->name }}</div>
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            ...
                            <tr class="border-bottom border-secondary border-opacity-10">
                                ...
                                <td class="py-3 text-end px-3 fw-bold">${{ number_format($item->subtotal, 2) }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
                            <tr>
                                ...
                                <td class="text-end py-4 px-3">
                                    <span class="h4 fw-bold text-primary">${{ number_format($totalAmount, 2) }}</span>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
