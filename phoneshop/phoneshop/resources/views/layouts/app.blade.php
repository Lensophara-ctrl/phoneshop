...
<div class="sidebar shadow" id="sidebar">
    <div class="sidebar-header">
        <a href="{{ route('profile.show') }}" class="text-decoration-none hover-opacity">
            @php
            ...
            <div class="d-flex align-items-center mb-2">
                @if($storeLogo)
                    <img src="{{ asset('storage/' . $storeLogo) }}" alt="{{ $storeName }}" class="me-3" style="height: 45px; width: 45px; object-fit: contain; filter: drop-shadow(0 2px 8px rgba(139, 92, 246, 0.3));">
                @else
                    <div class="d-flex align-items-center justify-content-center me-3" style="width: 45px; height: 45px; background: var(--primary-gradient); border-radius: 12px; box-shadow: 0 4px 12px rgba(139, 92, 246, 0.35);">
                        <i class="fa-solid {{ $storeIcon }}" style="color: white; font-size: 1.5rem;"></i>
                    </div>
                @endif
                <div>
    ...
    <div class="sidebar-menu">
        ...
        @permission('view_phones')
            <a href="{{ route('phones.index') }}" class="sidebar-link {{ request()->routeIs('phones.*') ? 'active' : '' }}">
        ...
        @permission('view_sales')
            <a href="{{ route('sales.index') }}" class="sidebar-link {{ request()->routeIs('sales.index') || request()->routeIs('sales.show') ? 'active' : '' }}">
                <i class="fa-solid fa-cart-shopping"></i><span>Sales History</span>
            </a>
        @endpermission
        @permission('approve_orders')
            <a href="{{ route('orders.approval') }}" class="sidebar-link {{ request()->routeIs('orders.approval') ? 'active' : '' }}">
        ...
        @permission('manage_slides')
            <a href="{{ route('slides.index') }}" class="sidebar-link {{ request()->routeIs('slides.*') ? 'active' : '' }}">
        ...
        <!-- User Profile & Logout -->
        <div class="mt-4 mb-3">
            <a href="{{ route('profile.show') }}" class="d-flex align-items-center mb-3 text-decoration-none hover-opacity px-2">
                <div class="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 42px; height: 42px; flex-shrink: 0; background: var(--primary-gradient) !important; box-shadow: 0 4px 12px rgba(139, 92, 246, 0.35); border: 2px solid rgba(255, 255, 255, 0.1);">
                    @if(Auth::user()->profile_image)
                        <img src="{{ asset('storage/' . Auth::user()->profile_image) }}" class="rounded-circle" style="width: 42px; height: 42px; object-fit: cover;">
                    @else
                        <span style="font-size: 16px; font-weight: 600;">{{ substr(Auth::user()->name, 0, 1) }}</span>
                    @endif
                </div>
                <div style="min-width: 0; flex: 1;">
                    <div class="small fw-semibold text-white text-truncate" style="font-size: 13px;">{{ Auth::user()->name }}</div>
                    <div class="x-small text-muted text-truncate" style="font-size: 11px; opacity: 0.6;">{{ Auth::user()->role ?? 'Administrator' }}</div>
                </div>
            </a>
    ...
    <div class="top-nav">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                <li><a class="dropdown-item" href="{{ route('profile.show') }}"><i class="fa-solid fa-user me-2"></i>My Profile</a></li>
                <li><a class="dropdown-item" href="{{ route('shop.home') }}"><i class="fa-solid fa-shop me-2"></i>View Shop</a></li>
