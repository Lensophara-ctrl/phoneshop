...
<form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
    ...
    <ul class="nav nav-tabs settings-tabs" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="chatbot-tab" data-bs-toggle="tab" data-bs-target="#chatbot-tab-pane" type="button" role="tab">
    ...
    <div class="tab-content">
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div id="logoPreviewContainer" class="mb-3 p-3 border rounded bg-light text-center" style="{{ $currentLogo ? '' : 'display: none;' }}">
                                <img src="{{ $currentLogo ? asset('storage/' . $currentLogo) : '' }}" 
                                     alt="Current Logo" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            @endphp
                            <input type="text" name="store_icon" id="storeIconInput" value="{{ $currentIcon }}" class="form-control mb-3" placeholder="fa-store">
                            ...
                            <div class="mt-3 p-3 border rounded bg-light">
                                ...
                                <div class="d-flex align-items-center">
                                    <i class="fa-solid {{ $currentIcon }} me-2" id="iconPreview" style="font-size: 2rem; color: var(--primary-color); transition: all 0.2s ease;"></i>
                                    <span class="fw-bold" style="font-size: 1.5rem;">{{ $settings->firstWhere('key', 'store_name')?->value ?? 'Your Store' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-section">
                ...
                <div class="row g-4">
                    @foreach($settings as $setting)
                        @if(in_array($setting->key, ['store_name', 'store_email', 'store_phone']))
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">
                                        @switch($setting->key)
        ...
        <div class="tab-pane fade" id="footer-tab-pane" role="tabpanel" tabindex="0">
            <div class="form-section">
                ...
                <div class="row g-4">
                    @foreach($settings as $setting)
                        @if($setting->key == 'footer_about')
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="form-label">
                                        <i class="fa-solid fa-info-circle me-2"></i>About Section
                                    </label>
                                    <textarea name="{{ $setting->key }}" class="form-control" placeholder="Enter footer about text">{{ $setting->value }}</textarea>
                                    <small class="text-muted">This text appears in the About section of the footer</small>
                                </div>
                            </div>
                        @elseif($setting->key == 'footer_text')
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">
                                        <i class="fa-solid fa-heading me-2"></i>Footer Text
                                    </label>
                                    <input type="text" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="e.g. PhoneShop. All rights reserved.">
                                </div>
                            </div>
                        @elseif($setting->key == 'footer_copyright')
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">
                                        <i class="fa-solid fa-copyright me-2"></i>Copyright Text
                                    </label>
                                    <input type="text" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="e.g. &copy; 2026">
                                </div>
                            </div>
                        @elseif($setting->key == 'footer_facebook')
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">
                                        <i class="fab fa-facebook me-2"></i>Facebook URL
                                    </label>
                                    <input type="url" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="https://facebook.com/yourpage">
                                </div>
                            </div>
                        @elseif($setting->key == 'footer_twitter')
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">
                                        <i class="fab fa-twitter me-2"></i>Twitter URL
                                    </label>
                                    <input type="url" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="https://twitter.com/yourhandle">
                                </div>
                            </div>
                        @elseif($setting->key == 'footer_instagram')
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">
                                        <i class="fab fa-instagram me-2"></i>Instagram URL
                                    </label>
                                    <input type="url" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="https://instagram.com/yourprofile">
                                </div>
                            </div>
                        @elseif($setting->key == 'footer_linkedin')
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">
                                        <i class="fab fa-linkedin me-2"></i>LinkedIn URL
                                    </label>
                                    <input type="url" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="https://linkedin.com/company/yourcompany">
                                </div>
                            </div>
                        @endif
                    @endforeach
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="footer_section_titles_quick_links" value="{{ $titles['quick_links'] ?? 'Quick Links' }}" class="form-control" placeholder="Quick Links">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-label"><i class="fa-solid fa-headset me-2"></i>Support Title</label>
                            <input type="text" name="footer_section_titles_support" value="{{ $titles['support'] ?? 'Support' }}" class="form-control" placeholder="Support">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-label"><i class="fa-solid fa-users me-2"></i>Follow Us Title</label>
                            <input type="text" name="footer_section_titles_follow_us" value="{{ $titles['follow_us'] ?? 'Follow Us' }}" class="form-control" placeholder="Follow Us">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div id="quickLinksContainer">
                    @foreach($quickLinks as $index => $link)
                        <div class="link-row row g-2 mb-2 align-items-end">
                            <div class="col-md-4">
                                <input type="text" name="footer_quick_links[{{ $index }}][title]" value="{{ $link['title'] }}" class="form-control" placeholder="Link Title">
                            </div>
                            <div class="col-md-4">
                                <input type="text" name="footer_quick_links[{{ $index }}][url]" value="{{ $link['url'] }}" class="form-control" placeholder="URL">
                            </div>
                            <div class="col-md-3">
                                <input type="text" name="footer_quick_links[{{ $index }}][icon]" value="{{ $link['icon'] }}" class="form-control" placeholder="fa-icon-class">
                            </div>
                            <div class="col-md-1">
            ...
            <div class="form-section mt-4">
                ...
                <div id="supportLinksContainer">
                    @foreach($supportLinks as $index => $link)
                        <div class="link-row row g-2 mb-2 align-items-end">
                            <div class="col-md-4">
                                <input type="text" name="footer_support_links[{{ $index }}][title]" value="{{ $link['title'] }}" class="form-control" placeholder="Link Title">
                            </div>
                            <div class="col-md-4">
                                <input type="text" name="footer_support_links[{{ $index }}][url]" value="{{ $link['url'] }}" class="form-control" placeholder="URL">
                            </div>
                            <div class="col-md-3">
                                <input type="text" name="footer_support_links[{{ $index }}][icon]" value="{{ $link['icon'] }}" class="form-control" placeholder="fa-icon-class">
                            </div>
                            <div class="col-md-1">
                                <button type="button" class="btn btn-outline-danger remove-link" onclick="this.closest('.link-row').remove()">
                                    <i class="fa-solid fa-trash"></i>
        ...
        <div class="tab-pane fade" id="chatbot-tab-pane" role="tabpanel" tabindex="0">
            <div class="form-section">
                <h4 class="form-section-title">Live Chat Auto-Reply Bot</h4>
                <p class="text-muted mb-4">Configure the automatic bot reply sent when a customer starts a chat or sends a message.</p>
                <div class="row g-4">
                    @php
                        $chatbotEnabled = $settings->firstWhere('key', 'chatbot_enabled')?->value;
                        $chatbotReply = $settings->firstWhere('key', 'chatbot_reply_message')?->value;
                    @endphp
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="chatbot_enabled" value="1" id="chatbotEnabled" {{ $chatbotEnabled == '1' ? 'checked' : '' }}>
                                <label class="form-check-label fw-bold" for="chatbotEnabled">
                                    <i class="fa-solid fa-robot me-2"></i>Enable Auto-Reply Bot
                                </label>
                            </div>
                            <small class="text-muted d-block mt-1">When enabled, customers will receive an automatic reply after sending a message.</small>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="form-label">
                                <i class="fa-solid fa-message me-2"></i>Auto-Reply Message
                            </label>
                            <textarea name="chatbot_reply_message" class="form-control" rows="4" placeholder="Thank you for reaching out! Our team will get back to you shortly.">{{ $chatbotReply ?? 'Thank you for reaching out! Our team will get back to you shortly.' }}</textarea>
                            <small class="text-muted">This message will be sent automatically when a customer starts a chat or sends a message.</small>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card settings-card mb-4">
        ...
        <div class="card-body">
            <div class="row g-3">
                @foreach($settings as $setting)
                    @if($setting->key == 'about_hero_title')
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Hero Title</label>
                                <input type="text" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="About Us">
                            </div>
                        </div>
                    @elseif($setting->key == 'about_hero_subtitle')
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Hero Subtitle</label>
                                <input type="text" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="Your trusted partner...">
                            </div>
                        </div>
                    @elseif($setting->key == 'about_story_title')
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="Our Story">
                            </div>
                        </div>
                    @elseif($setting->key == 'about_story_content')
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label">Story Content</label>
                                <textarea name="{{ $setting->key }}" class="form-control" rows="6" placeholder="Tell your company story...">{{ $setting->value }}</textarea>
                                <small class="text-muted">Write your company's story and mission</small>
                            </div>
                        </div>
                    @elseif($setting->key == 'about_stat_customers')
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="form-label">Customers Stat</label>
                                <input type="text" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="1000+">
                            </div>
                        </div>
                    @elseif($setting->key == 'about_stat_products')
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="form-label">Products Stat</label>
                                <input type="text" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="500+">
                            </div>
                        </div>
                    @elseif($setting->key == 'about_stat_authentic')
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="form-label">Authentic Stat</label>
                                <input type="text" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="100%">
                            </div>
                        </div>
                    @elseif($setting->key == 'about_stat_support')
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="form-label">Support Stat</label>
                                <input type="text" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="24/7">
                            </div>
                        </div>
                    @endif
                @endforeach
    ...
    <div class="card settings-card mb-4">
        ...
        <div class="card-body">
            <div class="row g-3">
                @foreach($settings as $setting)
                    @if($setting->key == 'about_cv_enabled')
                        <div class="col-md-12">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="{{ $setting->key }}" value="1" id="cvEnabled" {{ $setting->value == '1' ? 'checked' : '' }}>
                                <label class="form-check-label fw-bold" for="cvEnabled">
                                    Enable CV/Resume Section on About Us Page
                                </label>
                            </div>
                        </div>
                    @elseif($setting->key == 'about_cv_photo')
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @if($setting->value)
                                    <div class="mt-2">
                                        <img src="{{ asset('storage/' . $setting->value) }}" alt="CV Photo" class="rounded-circle" style="width: 80px; height: 80px; object-fit: cover;">
                                    </div>
                                @endif
                            </div>
                        </div>
                    @elseif($setting->key == 'about_cv_name')
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Full Name</label>
                                <input type="text" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="Mr. Len Sophara">
                            </div>
                        </div>
                    @elseif($setting->key == 'about_cv_position')
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Position/Title</label>
                                <input type="text" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="Software Engineer">
                            </div>
                        </div>
                    @elseif($setting->key == 'about_cv_email')
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Email</label>
                                <input type="email" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="email@example.com">
                            </div>
                        </div>
                    @elseif($setting->key == 'about_cv_phone')
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Phone</label>
                                <input type="text" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="060276538">
                            </div>
                        </div>
                    @elseif($setting->key == 'about_cv_bio')
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label">Bio/About</label>
                                <textarea name="{{ $setting->key }}" class="form-control" rows="3" placeholder="Brief introduction...">{{ $setting->value }}</textarea>
                            </div>
                        </div>
                    @elseif($setting->key == 'about_cv_skills')
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label">Skills (comma separated)</label>
                                <input type="text" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="UI/UX, C#, C++, JavaScript, Laravel, React">
                                <small class="text-muted">Separate skills with commas</small>
                            </div>
                        </div>
                    @elseif($setting->key == 'about_cv_education')
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label">Education</label>
                                <textarea name="{{ $setting->key }}" class="form-control" rows="3" placeholder="University details...">{{ $setting->value }}</textarea>
                            </div>
                        </div>
                    @elseif($setting->key == 'about_cv_experience')
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label">Experience</label>
                                <textarea name="{{ $setting->key }}" class="form-control" rows="3" placeholder="Work experience...">{{ $setting->value }}</textarea>
                            </div>
                        </div>
                    @endif
                @endforeach
    ...
    <div class="card settings-card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                @foreach($settings as $setting)
                    @if($setting->key == 'telegram_enabled')
                        <div class="col-md-12">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="{{ $setting->key }}" value="1" id="telegramEnabled" {{ $setting->value == '1' ? 'checked' : '' }}>
                    ...
                    @elseif($setting->key == 'telegram_bot_token')
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="123456789:ABCdefGHIjklMNOpqrsTUVwxyz">
                            </div>
                        </div>
                    @elseif($setting->key == 'telegram_chat_id')
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="{{ $setting->key }}" value="{{ $setting->value }}" class="form-control" placeholder="123456789">
                            </div>
                        </div>
                    @endif
                @endforeach
                ...
                <div class="col-md-12">
                    <a href="{{ route('test.telegram') }}" class="btn btn-info" target="_blank">
