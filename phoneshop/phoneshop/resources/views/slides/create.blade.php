    ...
    <div class="col-lg-6">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <form action="{{ route('slides.store') }}" method="POST" enctype="multipart/form-data" id="slideForm">
                    @csrf
                    <div class="row g-4">
                        <div class="col-12">
                            <label class="form-label fw-semibold">Title</label>
                            <input type="text" name="title" id="slideTitle" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" required>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" id="slideDescription" class="form-control" rows="3">{{ old('description') }}</textarea>
                        </div>

                        <div class="col-12">
                            <label class="form-label fw-semibold">Button Text</label>
                            <input type="text" name="button_text" id="slideButtonText" class="form-control" value="{{ old('button_text') }}">
                        </div>

                        <div class="col-12">
                            <label class="form-label fw-semibold">Button Link</label>
                            <input type="text" name="button_link" id="slideButtonLink" class="form-control" value="{{ old('button_link') }}">
                        </div>
