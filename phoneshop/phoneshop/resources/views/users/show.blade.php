...
<div class="container">
    ...
    <div class="profile-header">
        ...
        <h1 class="profile-info-title">{{ $user->name }}</h1>
        ...
        <div class="meta-info">
            ...
            <div class="meta-item">
                <div class="meta-value">{{ $user->created_at->format('Y') }}</div>
    ...
    <div class="action-buttons">
        <a href="{{ route('users.reset-password', $user) }}" class="btn-custom btn-primary-custom">
            <i class="fa-solid fa-key"></i>Reset Password
        </a>
        @if($user->id !== auth()->id())
            <form method="POST" action="{{ route('users.destroy', $user) }}" onsubmit="return confirm('Are you sure you want to delete this user?');" style="width: 100%;">
                @csrf
                @method('DELETE')
        ...
        @endif
        <a href="{{ route('users.index') }}" class="btn-custom btn-secondary-custom">
