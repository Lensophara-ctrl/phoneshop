    ...
    <div class="dashboard-header">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            <div class="d-flex gap-3 align-items-center">
                <a href="<?php echo e(route('sales.create')); ?>" class="btn-primary-custom">
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-6 col-lg-3">
            <div class="stat-card blue">
                ...
                <div class="stat-value">$<?php echo e(number_format($totalRevenue ?? 0, 2)); ?></div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="stat-card orange">
                ...
                <div class="stat-value"><?php echo e($phones ?? 0); ?></div>
                <div class="stat-change">
                    <i class="fa-solid fa-layer-group"></i>
                    <span><?php echo e($categories ?? 0); ?> categories</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="stat-card purple">
                ...
                <div class="stat-value"><?php echo e($users ?? 0); ?></div>
                <div class="stat-change">
                    <i class="fa-solid fa-arrow-up"></i>
        ...
        <div class="col-lg-8">
            <div class="chart-card">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <span class="badge" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);"><?php echo e(date('F Y')); ?></span>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const salesData = <?php echo json_encode($salesData ?? [12500, 18200, 15800, 22400]); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Practice\phoneshop\phoneshop\resources\views/dashboard.blade.php ENDPATH**/ ?>