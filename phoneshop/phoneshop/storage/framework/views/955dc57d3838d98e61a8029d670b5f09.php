    ...
    <div class="checkout-container">
        ...
        <div class="checkout-content">
            <div class="customer-info-section">
                ...
                <form action="<?php echo e(route('shop.payment.method')); ?>" method="POST" id="checkoutForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   name="customer_name" 
                                   class="form-control" 
                                   value="<?php echo e(auth()->check() ? auth()->user()->name : old('customer_name')); ?>" 
                                   required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" 
                                   ...
                                   name="customer_email" 
                                   class="form-control" 
                                   value="<?php echo e(auth()->check() ? auth()->user()->email : old('customer_email')); ?>" 
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="tel" 
                                   ...
                                   name="customer_phone" 
                                   class="form-control" 
                                   value="<?php echo e(auth()->check() ? auth()->user()->phone : old('customer_phone')); ?>" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   name="customer_city" 
                                   class="form-control" 
                                   value="<?php echo e(old('customer_city')); ?>" 
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="customer_address" 
                                  ...
                                  required><?php echo e(auth()->check() ? auth()->user()->address : old('customer_address')); ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               class="form-control" 
                               value="<?php echo e(old('customer_postal_code')); ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="order_notes" 
                                  ...
                                  class="form-control" 
                                  rows="3" 
                                  placeholder="Any special instructions or notes for your order (optional)"><?php echo e(old('order_notes')); ?></textarea>
                    </div>
                ...
                <a href="<?php echo e(route('shop.cart')); ?>" class="back-link">
            ...
            <div class="order-summary-section">
                ...
                <div class="summary-items">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        ...
                        <div class="summary-item">
                            <div class="item-info">
                                <span class="item-name"><?php echo e($phone->name); ?></span>
                                <span class="item-qty">x<?php echo e($item['qty']); ?></span>
                            </div>
                            <span class="item-price">$<?php echo e(number_format($itemTotal, 2)); ?></span>
                        </div>
                ...
                <div class="summary-totals">
                    ...
                    <div class="summary-row">
                        <span>Tax:</span>
                        <span>$<?php echo e(number_format($subtotal * 0.1, 2)); ?></span>
                    </div>
                    <div class="summary-row total">
                        <span>Total:</span>
                        <span>$<?php echo e(number_format($subtotal * 1.1, 2)); ?></span>
                    </div>
                </div>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Practice\phoneshop\phoneshop\resources\views/frontend/checkout.blade.php ENDPATH**/ ?>