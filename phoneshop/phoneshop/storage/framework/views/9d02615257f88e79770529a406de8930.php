        ...
        <form method="POST" action="<?php echo e(route('customer.register')); ?>">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="tel" class="form-control" id="phone" name="phone" 
                           placeholder="e.g., +855 12 345 678" value="<?php echo e(old('phone')); ?>" required>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="address" name="address" rows="2" 
                          placeholder="Enter your address" required><?php echo e(old('address')); ?></textarea>
            </div>
...
<?php /**PATH C:\laragon\www\Practice\phoneshop\phoneshop\resources\views/auth/register.blade.php ENDPATH**/ ?>