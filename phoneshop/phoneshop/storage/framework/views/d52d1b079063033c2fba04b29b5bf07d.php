...
<div class="invoice-container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 no-print">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="<?php echo e(route('sales.index')); ?>" class="btn btn-modern btn-outline-secondary">
        ...
        <div class="invoice-header">
            <div class="row align-items-center position-relative">
                <div class="col-md-6">
                    ...
                    <h1 class="invoice-title">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($storeLogo): ?>
                            <img src="<?php echo e(asset('storage/' . $storeLogo)); ?>" alt="<?php echo e($storeName); ?>" style="height: 50px; width: auto; object-fit: contain; margin-right: 1rem;">
                        <?php else: ?>
                            <i class="fa-solid <?php echo e($storeIcon); ?> me-3"></i>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php echo e($storeName); ?>

                    </h1>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($storePhone || $storeEmail): ?>
                        <div class="mt-3 opacity-90">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($storePhone): ?>
                                <div><i class="fa-solid fa-phone me-2"></i><?php echo e($storePhone); ?></div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($storeEmail): ?>
                                <div><i class="fa-solid fa-envelope me-2"></i><?php echo e($storeEmail); ?></div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <div class="col-md-6 text-md-end mt-4 mt-md-0">
                    ...
                    <div class="mt-3">
                        <div class="h5 mb-2"><span data-translate="bill_no">Bill No</span>: #<?php echo e($sale->bill_no); ?></div>
                        <div><span data-translate="date">Date</span>: <?php echo e($sale->created_at->format('M d, Y h:i A')); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-6">
                    <div class="info-card h-100">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sale->customer_name || $sale->user): ?>
                            <div class="info-value"><?php echo e($sale->customer_name ?? $sale->user->name); ?></div>
                            <div class="text-muted mt-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sale->customer_email): ?>
                                    <i class="fa-solid fa-envelope me-1"></i><?php echo e($sale->customer_email); ?><br>
                                <?php elseif($sale->user): ?>
                                    <i class="fa-solid fa-envelope me-1"></i><?php echo e($sale->user->email); ?><br>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sale->customer_phone): ?>
                                    <i class="fa-solid fa-phone me-1"></i><?php echo e($sale->customer_phone); ?><br>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sale->customer_address): ?>
                                    <i class="fa-solid fa-location-dot me-1"></i><?php echo e($sale->customer_address); ?>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sale->customer_city): ?>, <?php echo e($sale->customer_city); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sale->customer_postal_code): ?> <?php echo e($sale->customer_postal_code); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sale->order_notes): ?>
                                <div class="mt-2 p-2 bg-light rounded">
                                    <small class="text-muted"><i class="fa-solid fa-note-sticky me-1"></i><strong>Notes:</strong></small><br>
                                    <small><?php echo e($sale->order_notes); ?></small>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php else: ?>
                ...
                <div class="col-md-6">
                    <div class="info-card h-100">
                        ...
                        <div class="info-value text-uppercase"><?php echo e(str_replace('_', ' ', $sale->payment_method)); ?></div>
                        <div class="mt-2">
                ...
                <table class="table items-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo e($formatMoney($displayPrice, $sale->currency)); ?></td>
                            <td class="text-center"><span class="badge bg-primary"><?php echo e($item->qty); ?></span></td>
                            <td class="text-end fw-bold"><?php echo e($formatMoney($displaySubtotal, $sale->currency)); ?></td>
                        </tr>
                ...
                <div class="col-md-5">
                    <div class="total-section">
                        ...
                        <div class="d-flex justify-content-between mb-2 pb-2">
                            ...
                            <span class="fw-bold"><?php echo e($formatMoney($subtotal, $sale->currency)); ?></span>
                        </div>
                        <div class="d-flex justify-content-between mb-3 pb-3 border-bottom">
                            <span class="text-muted"><span data-translate="tax">Tax</span>:</span>
                            <span class="fw-bold"><?php echo e($formatMoney($tax, $sale->currency)); ?></span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="h5 mb-0 fw-bold"><span data-translate="grand_total">Grand Total</span>:</span>
                            <span class="grand-total"><?php echo e($formatMoney($total, $sale->currency)); ?></span>
                        </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sale->currency === 'KHR'): ?>
                            <div class="text-end small text-muted mt-2">
                                <span data-translate="equivalent">Equivalent</span>: $<?php echo e(number_format($sale->total_price, 2)); ?>

                            </div>
                        <?php else: ?>
                            <div class="text-end small text-muted mt-2">
                                <span data-translate="equivalent">Equivalent</span>: <?php echo e(number_format($sale->total_price * $sale->exchange_rate, 0)); ?> ៛
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Practice\phoneshop\phoneshop\resources\views/sales/show.blade.php ENDPATH**/ ?>