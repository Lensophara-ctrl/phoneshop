        ...
        <div class="col-lg-6">
            ...
            <div class="profile-hero">
                ...
                <div class="text-center">
                    <a href="<?php echo e(route('profile.edit')); ?>" class="change-picture-link">
            ...
            <div class="profile-card">
                ...
                <div class="profile-section">
                    ...
                    <div>
                        <span class="profile-badge <?php echo e($user->role === 'admin' ? 'admin' : 'customer'); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->role === 'admin'): ?>
                ...
                <div class="profile-section">
                    ...
                    <div class="d-grid gap-2">
                        <a href="<?php echo e(route('customer.orders')); ?>" class="btn btn-outline-primary btn-lg">
                            <i class="fa-solid fa-shopping-bag me-2"></i>My Orders
                            <span class="badge bg-primary ms-2"><?php echo e(\App\Models\Sale::where('user_id', $user->id)->count()); ?></span>
                        </a>
                        <a href="<?php echo e(route('shop.cart')); ?>" class="btn btn-outline-secondary">
                ...
                <div class="profile-section">
                    <div class="btn-group-profile">
                        <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-primary fw-semibold">
                            <i class="fa-solid fa-pen me-2"></i>Edit Profile
                        </a>
                        <a href="<?php echo e(Auth::user()->role === 'admin' ? route('dashboard') : route('shop.home')); ?>" class="btn btn-outline-secondary fw-semibold">
...
<?php echo $__env->make(Auth::user()->role === 'admin' ? 'layouts.app' : 'frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Practice\phoneshop\phoneshop\resources\views/profile/show.blade.php ENDPATH**/ ?>