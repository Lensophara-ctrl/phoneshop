    ...
    <div class="login-card">
        ...
        <form action="<?php echo e(route('admin.login')); ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control" id="email" placeholder="name@example.com" value="<?php echo e(old('email')); ?>" required autofocus>
            </div>
            <div class="mb-4">
        ...
        <div class="text-center mt-5 pt-4 border-top">
            ...
            <p class="small text-muted mb-0">
                <a href="<?php echo e(route('shop.home')); ?>" class="text-decoration-none" style="color: #667eea;">
...
<?php /**PATH C:\laragon\www\Practice\phoneshop\phoneshop\resources\views/auth/admin-login.blade.php ENDPATH**/ ?>